...
Инструмент для парсинга организаций в Яндексе: Parser_Maps (Карты) и Parser_search (поиск).
...
GUI позволяет выбирать между «Parser_Maps» (скрапер по картам) и «Parser_search» (парсинг поиска) режимами.
